...
<p align="center">
  <a href="https://github.com/llmsieve/llm-sieve/blob/v1.0.0/LICENSE"><img alt="License" src="https://img.shields.io/badge/license-Apache%202.0-blue.svg"></a>
  ...
  <a href="https://github.com/llmsieve/llm-sieve/blob/v1.0.0/PATENT_NOTICE"><img alt="Patent" src="https://img.shields.io/badge/patent-pending-lightgrey.svg"></a>
</p>
...
<p align="center"><img src="https://raw.githubusercontent.com/llmsieve/llm-sieve/v1.0.0/branding/sieve-quick-install.gif" alt="One-command install demo" width="720"></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/llmsieve/llm-sieve/v1.0.0/branding/sieve-wizard.gif" alt="Interactive management menu" width="720"></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/llmsieve/llm-sieve/v1.0.0/branding/sieve-benchmark.gif" alt="Benchmark — 90% fewer tokens on a real run" width="720"></p>
...
After `sieve-install`, your config lives at `~/.sieve/sieve.yaml`. The shipping example — with commentary on every option — is [`sieve.example.yaml`](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/sieve.example.yaml).
...
Reporting a vulnerability: do not open a public issue — see [SECURITY.md](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/SECURITY.md).

## Open source

Apache License 2.0. You are free to use, modify, and distribute Sieve, including commercially, under the terms in [LICENSE](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/LICENSE).

Sieve implements inventions covered by a pending UK patent application ([GB2608859.1](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/PATENT_NOTICE)). Apache 2.0 includes an automatic, royalty-free patent licence for users of the software — see the [patent notice](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/PATENT_NOTICE) for the terms.

## Contributing

Issues, bug reports, and pull requests are welcome. Contributions require a DCO sign-off (`git commit -s`). See [CONTRIBUTING.md](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/CONTRIBUTING.md).
...
[Apache License 2.0](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/LICENSE). See [PATENT_NOTICE](https://github.com/llmsieve/llm-sieve/blob/v1.0.0/PATENT_NOTICE) for patent terms.
